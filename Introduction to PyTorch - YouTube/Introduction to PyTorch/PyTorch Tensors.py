...
# Basic Tensor manipulations. First we see how to create tensors.
z = torch.zeros(5, 3)
print(z)
print(z.dtype)

# We have created a 5x3 matrix filled with zeroes, and find its datatype. It is 32-bit floating point numbers, which is default pytorch

# What if you wanted integers?
